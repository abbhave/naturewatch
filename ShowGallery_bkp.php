...
$query = 'SELECT c.commonname,imageid,imagelink,i.date,l.locationname from '.$tablename.' c,ImageInfo i,locationinfo l where c.commonname=i.commonname and i.locationname=l.locationname';
//$query.=$tablename;
